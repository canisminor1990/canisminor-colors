...
export class Hct {
  ...
  set hue(newHue: number) {
    this.setInternalState(CamSolver.solveToInt(newHue, this.internalChroma, this.internalTone));
  }
  ...
  set chroma(newChroma: number) {
    this.setInternalState(CamSolver.solveToInt(this.internalHue, newChroma, this.internalTone));
  }
  ...
  set tone(newTone: number) {
    this.setInternalState(CamSolver.solveToInt(this.internalHue, this.internalChroma, newTone));
  }
