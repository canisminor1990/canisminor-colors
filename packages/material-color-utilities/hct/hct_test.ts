...
describe('CAM to ARGB', () => {
  ...
  it('blue', () => {
    ...
    expect(cam.chroma).toBeCloseTo(87.23, 0.001);
...
describe('viewing conditions', () => {
  it('default', () => {
    ...
    expect(vc.aw).toBeCloseTo(29.98, 0.001);
